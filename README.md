...
## 🆕 NEW: MCP2515 CAN Bus Support

This firmware now supports **MCP2515 CAN bus communication** with automatic detection and fallback to USART2/USART3!

**Features:**
- ✅ Auto-detects MCP2515 or falls back to USART mode
- ✅ Software SPI on shared pins (PA2/PA3/PB10/PB11)
- ✅ PWM, Speed, and Position control via CAN
- ✅ Real-time status feedback (100ms interval)
...
**Documentation:**
- [CAN Integration Summary](CAN_INTEGRATION_SUMMARY.md) - Quick reference
- [MCP2515 Wiring Guide](MCP2515_WIRING.md) - Hardware connections
- [Complete CAN Documentation](CAN_BUS_README.md) - Full details
