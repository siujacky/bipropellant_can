...
#define HOVERBOARD 6
#define CAN_CONTROLLED 7
#define CAN_WITH_HOVERBOARD 8
#define CAN_BUS 9
...
// implementaiton of specific for macro control types
  ...
  // CAN bus control via MCP2515
  // Auto-detects MCP2515 on shared pins with USART2/USART3
  ...
  #define INVERT_R_DIRECTION 0
  #define INVERT_L_DIRECTION 0
  // Enable USART2 for debug output at 115200 baud
  #define SERIAL_USART2_IT
  #define USART2_BAUD 115200
  // Console on PA13/PA14 (SWD pins) - only enabled after MCP2515 detected
  // This keeps SWD available for debugging if CAN init fails
  #define SOFTWARE_SERIAL
  #define SOFTWARE_SERIAL_BAUD 115200
  #define SOFTWARE_SERIAL_RX_PIN GPIO_PIN_14
  #define SOFTWARE_SERIAL_RX_PORT GPIOA
...
#if (CONTROL_TYPE == CAN_WITH_HOVERBOARD)
  // CAN bus control via MCP2515 + Hoverboard sensor support
  ...
  #define SERIAL_USART2_IT
  #define SERIAL_USART3_IT
  #define USART2_BAUD     26315    // Sensor board baudrate
  #define USART3_BAUD     26315    // Sensor board baudrate
  #define USART2_WORDLENGTH UART_WORDLENGTH_9B
  #define USART3_WORDLENGTH UART_WORDLENGTH_9B
  #define SERIAL_USART_IT_BUFFERTYPE unsigned short
  #define PHASE_ADV_ENA 0
...
#if (CONTROL_TYPE == CAN_BUS)
  // CAN bus control ONLY via MCP2515 - NO hoverboard sensors
  // PA2/PA3 and PB10/PB11 used for Software SPI to MCP2515
  ...
  // NO sensor reading - pure CAN control
  // READ_SENSOR and CONTROL_SENSOR intentionally NOT defined
  ...
  // Software Serial on PA13/PA14 (SWD pins) for debug output
  // USART2/USART3 pins are used by Software SPI for MCP2515
  #define SOFTWARE_SERIAL
  #define SOFTWARE_SERIAL_BAUD 115200
  #define SOFTWARE_SERIAL_RX_PIN GPIO_PIN_14
  #define SOFTWARE_SERIAL_RX_PORT GPIOA
